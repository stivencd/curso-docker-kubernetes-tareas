...
('Ratón Inalámbrico', 'Ratón ergonómico inalámbrico con conectividad 2.4 GHz', 25.99, 50, 'http://localhost/assets/mouse.png'),
('Teclado Mecánico', 'Teclado mecánico RGB con switches azules', 79.50, 30, 'http://localhost/assets/keyboard.png'),
('Hub USB-C', 'Hub USB-C multipuerto con HDMI, USB 3.0 y lector de tarjetas SD', 45.00, 20, 'http://localhost/assets/usb_hub.png'),
('Auriculares Gamer', 'Auriculares over-ear con sonido envolvente para gaming', 59.99, 15, 'http://localhost/assets/headset.png'),
('Cámara Web 1080p', 'Cámara web HD con micrófono incorporado', 39.99, 25, 'http://localhost/assets/webcam.png');
